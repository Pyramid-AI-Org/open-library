...
class Crawler:
    ...
    def crawl(self, ctx: RunContext) -> list[UrlRecord]:
        ...
        page_url = str(
            cfg.get(
                "page_url",
                "https://www.td.gov.hk/en/publications_and_press_releases/publications/free_publications/the_second_parking_demand_study_final_report_/index.html",
            )
        ).strip()
