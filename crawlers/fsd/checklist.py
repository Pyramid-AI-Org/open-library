...
_DEFAULT_PAGE_URL = "https://www.hkfsd.gov.hk/eng/fire_protection/notices/checklist.html"
...
class _ChecklistRowsParser(HTMLParser):
...
class Crawler:
    ...
    def crawl(self, ctx: RunContext) -> list[UrlRecord]:
        ...
        for row in parser.rows:
            ...
            publish_date = normalize_publish_date(name)
