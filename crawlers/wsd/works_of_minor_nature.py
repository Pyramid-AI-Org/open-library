...
_DEFAULT_PAGE_URL = (
    "https://www.wsd.gov.hk/en/plumbing-engineering/works-of-a-minor-nature/index.html"
)
_DEFAULT_SCOPE_PREFIX = (
    "https://www.wsd.gov.hk/en/plumbing-engineering/works-of-a-minor-nature"
)


class Crawler:
    name = "works_of_minor_nature"
    ...
    def crawl(self, ctx: RunContext) -> list[UrlRecord]:
        ...
        return crawl_page_tree(
            ...
            mode=TraversalMode(
                ...
                emit_pdf_records=False,
                emit_pdf_from_seed=False,
                emit_pdf_from_subpages=False,
                include_seed_page_record=True,
                seed_page_discovered_from_self=True,
            ),
        )
