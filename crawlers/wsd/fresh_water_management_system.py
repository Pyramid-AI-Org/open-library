...
_DEFAULT_PAGE_URL = (
    "https://www.wsd.gov.hk/en/water-safety/fresh-water-management-system-/index.html"
)
_DEFAULT_SCOPE_PREFIX = (
    "https://www.wsd.gov.hk/en/water-safety/fresh-water-management-system-"
)


class Crawler:
    name = "fresh_water_management_system"
