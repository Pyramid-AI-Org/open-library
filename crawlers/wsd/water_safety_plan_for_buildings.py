...
_DEFAULT_PAGE_URL = (
    "https://www.wsd.gov.hk/en/water-safety/water-safety-in-buildings/index.html"
)
_DEFAULT_SCOPE_PREFIX = "https://www.wsd.gov.hk/en/water-safety/water-safety-in-buildings"


class Crawler:
    name = "water_safety_plan_for_buildings"
