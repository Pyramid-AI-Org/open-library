...
_DEFAULT_PAGE_URL = "https://www.wsd.gov.hk/en/water-safety/wspss/index.html"
_DEFAULT_SCOPE_PREFIX = "https://www.wsd.gov.hk/en/water-safety/wspss"


class Crawler:
    name = "water_safety_plan_subsidy_scheme"
