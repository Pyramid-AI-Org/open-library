...
_DEFAULT_PAGE_URL = (
    ...
    "maintenance-of-internal-plumbing/index.html"
)
_DEFAULT_SCOPE_PREFIX = (
    "https://www.wsd.gov.hk/en/plumbing-engineering/maintenance-of-internal-plumbing"
)


class Crawler:
    name = "maintenance_of_internal_plumbing"
