...
_DEFAULT_PAGE_URL = (
    ...
    "information-for-licensed-plumbers/index.html"
)
_DEFAULT_SCOPE_PREFIX = (
    "https://www.wsd.gov.hk/en/plumbing-engineering/information-for-licensed-plumbers"
)
_DEFAULT_EXCLUDE_SUBPAGES = [
    "https://www.wsd.gov.hk/en/plumbing-engineering/"
    "information-for-licensed-plumbers/"
    "demo-videos-on-installation-of-security-seals/index.html",
]


class Crawler:
    name = "information_for_licensed_plumbers"
    ...
    def crawl(self, ctx: RunContext) -> list[UrlRecord]:
        ...
        for raw_url in excluded_raw:
            can = canonicalize_wsd_url(raw_url)
            if can:
