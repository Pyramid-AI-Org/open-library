...
_DEFAULT_PAGE_URL = (
    "https://www.emsd.gov.hk/en/gas_safety/statutory_advisory_bodies/index.html"
)
_DEFAULT_SCOPE_PREFIX = (
    "https://www.emsd.gov.hk/en/gas_safety/statutory_advisory_bodies/"
)
...
class Crawler:
    name = "emsd.gas_statutory_advisory_bodies"
