...
class _OccupationalSafetyPageParser(HTMLParser):
...
def crawl_occupational_safety_part(
    *,
    ctx: RunContext,
    crawler_name: str,
    ...
    page_url = str(cfg.get("page_url", default_page_url)).strip()
    page_url_tc = clean_text(str(cfg.get("page_url_tc", "")))
    ...
    for listing_url in listings:
        ...
        parser = _OccupationalSafetyPageParser()
