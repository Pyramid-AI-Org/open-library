"""Lands Department — documents the department's own crawlers do not reach.

LAO and LACO practice notes and their attachments; the row parsers take one link per row.
